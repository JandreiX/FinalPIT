...
<html lang="en">
  ...
  <body>
    ...
    <section class="text-dark text-center text-sm-start p-5 mybg align-top">
      <div class="container">
        ...
        >
          ...
          <img src="<?php echo e(asset('images/header-img.png')); ?>" alt="" class="w-50 d-none d-sm-block hide-on-sm" />
        </div>
      </div>
    </section>
    ...
    <!--REGISTER-->
        ...
        <form id="registrationForm"  method="post" action="<?php echo e(route('submit.form')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\ObenzaCONeXT\resources\views/welcome.blade.php ENDPATH**/ ?>